...
var aroma_malt = new Slider("#aroma_malt", {
  ...
  ticks_labels: [
    '<p style="pointer-events:none;transform: translateY(15px) rotate(270deg);pointer-events:none;transform-origin: center;">None</p>',
    '<p style="pointer-events:none;transform: translateY(10px) rotate(270deg);pointer-events:none;transform-origin: center;">Low</p>',
    '<p style="pointer-events:none;transform: translateY(10px) rotate(270deg);pointer-events:none;transform-origin: center;">Med</p>',
    '<p style="pointer-events:none;transform: translateY(10px) rotate(270deg);pointer-events:none;transform-origin: center;">High</p>',
  ],
  ticks_snap_bounds: 3,
  value: 0,
});
...
var appearance_color = new Slider("#appearance_color", {
  ...
  //- ticks_labels: ['None','Low','Med','High'],
  ticks_labels: [
    '<p style="pointer-events:none;transform: translateY(15px) rotate(270deg);pointer-events:none;transform-origin: center;">Yellow</p>',
    '<p style="pointer-events:none;transform: translateY(10px) rotate(270deg);pointer-events:none;transform-origin: center;">Gold</p>',
    '<p style="pointer-events:none;transform: translateY(16px) rotate(270deg);pointer-events:none;transform-origin: center;">Amber</p>',
    '<p style="pointer-events:none;transform: translateY(16px) rotate(270deg);pointer-events:none;transform-origin: center;">Copper</p>',
    '<p style="pointer-events:none;transform: translateY(14px) rotate(270deg);pointer-events:none;transform-origin: center;">Brown</p>',
    '<p style="pointer-events:none;transform: translateY(10px) rotate(270deg);pointer-events:none;transform-origin: center;">Black</p>',
  ],
  ticks_snap_bounds: 3,
  value: 0,
});
var appearance_clarity = new Slider("#appearance_clarity", {
  ...
  //- ticks_labels: ['None','Low','Med','High'],
  ticks_labels: [
    '<p style="pointer-events:none;transform: translateY(18px) rotate(270deg);pointer-events:none;transform-origin: center;">Brilliant</p>',
    '<p style="pointer-events:none;transform: translateY(10px) rotate(270deg);pointer-events:none;transform-origin: center;">Hazy</p>',
    '<p style="pointer-events:none;transform: translateY(15px) rotate(270deg);pointer-events:none;transform-origin: center;">Opaque</p>',
  ],
  ticks_snap_bounds: 3,
  value: 0,
});
var appearance_head = new Slider("#appearance_head", {
  ...
  //- ticks_labels: ['None','Low','Med','High'],
  ticks_labels: [
    '<p style="pointer-events:none;transform: translateY(15px) rotate(270deg);pointer-events:none;transform-origin: center;">White</p>',
    '<p style="pointer-events:none;transform: translateY(12px) rotate(270deg);pointer-events:none;transform-origin: center;">Ivory</p>',
    '<p style="pointer-events:none;transform: translateY(15px) rotate(270deg);pointer-events:none;transform-origin: center;">Beige</p>',
    '<p style="pointer-events:none;transform: translateY(8px) rotate(270deg);pointer-events:none;transform-origin: center;">Tan</p>',
    '<p style="pointer-events:none;transform: translateY(14px) rotate(270deg);pointer-events:none;transform-origin: center;">Brown</p>',
  ],
  ticks_snap_bounds: 3,
  value: 0,
...
var flavor_balance = new Slider("#flavor_balance", {
  ...
  //- ticks_labels: ['None','Low','Med','High'],
  ticks_labels: [
    '<p style="pointer-events:none;transform: translateY(15px) rotate(270deg);pointer-events:none;transform-origin: center;">Hoppy</p>',
    '<p style="pointer-events:none;transform: translateY(12px) rotate(270deg);pointer-events:none;transform-origin: center;">Malty</p>',
  ],
  ticks_snap_bounds: 3,
  value: 0,
});
var flavor_finish_aftertaste = new Slider("#flavor_finish_aftertaste", {
  ...
  //- ticks_labels: ['None','Low','Med','High'],
  ticks_labels: [
    '<p style="pointer-events:none;transform: translateY(7px) rotate(270deg);pointer-events:none;transform-origin: center;">Dry</p>',
    '<p style="pointer-events:none;transform: translateY(12px) rotate(270deg);pointer-events:none;transform-origin: center;">Sweet</p>',
  ],
  ticks_snap_bounds: 3,
  value: 0,
});
...
var mouthfeel_body = new Slider("#mouthfeel_body", {
  ...
  ticks_labels: [
    '<p style="pointer-events:none;transform: translateY(15px) rotate(270deg);pointer-events:none;transform-origin: center;">None</p>',
    '<p style="pointer-events:none;transform: translateY(10px) rotate(270deg);pointer-events:none;transform-origin: center;">Thin</p>',
    '<p style="pointer-events:none;transform: translateY(10px) rotate(270deg);pointer-events:none;transform-origin: center;">Med</p>',
    '<p style="pointer-events:none;transform: translateY(10px) rotate(270deg);pointer-events:none;transform-origin: center;">Full</p>',
  ],
  ticks_snap_bounds: 3,
  value: 0,
});
...
var overall_class_example = new Slider("#overall_class_example", {
  ...
  //- ticks_labels: ['<p style="pointer-events:none;transform: translateY(15px) rotate(270deg);pointer-events:none;transform-origin: center;">Classic\nExample</p>', '<p style="pointer-events:none;transform: translateY(14px) rotate(270deg);pointer-events:none;transform-origin: center;">Not to\nStyle</p>'],
  ticks_snap_bounds: 3,
  value: 50,
});
var overall_flawless = new Slider("#overall_flawless", {
  ...
  //- ticks_labels: ['<p style="pointer-events:none;transform: translateY(15px) rotate(270deg);pointer-events:none;transform-origin: center;">Flawless</p>', '<p style="pointer-events:none;transform: translateY(18px) rotate(270deg);pointer-events:none;transform-origin: center;">Significant/nFlaws</p>'],
  ticks_snap_bounds: 3,
  value: 50,
});
var overall_wonderful = new Slider("#overall_wonderful", {
  ...
  //- ticks_labels: ['<p style="pointer-events:none;transform: translateY(16px) rotate(270deg);pointer-events:none;transform-origin: center;">Wonderful</p>', '<p style="pointer-events:none;transform: translateY(16px) rotate(270deg);pointer-events:none;transform-origin: center;">Lifeless</p>'],
  ticks_snap_bounds: 3,
  value: 50,
});
